...
export const routes: Routes = [
  ...
  { path: 'fields', loadChildren: () => import('./configuration/purchase-fields/purchase-fields.module').then(m => m.PurchaseFieldsModule), title: 'Purchase fields page', canActivate: [AuthGuard] },
