...
export class BankStatementComponent {
  ...
  banks: string[] = ['UNION BANK OF INDIA', 'CANARA BANK', 'ICICI BANK', 'INDIAN BANK', 'SBI', 'CITY UNION BANK', 'HDFC BANK', 'AXIS BANK', 'BANK OF INDIA', 'IDFC FIRST BANK', 'CENTRAL BANK OF INDIA','ANDHRA PRADESH GRAMEENA BANK'];
